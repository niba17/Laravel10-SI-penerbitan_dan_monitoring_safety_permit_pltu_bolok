...
@section('title', 'SASANDO | Pekerja - create')
@section('content')
                ...
                <div class="row row-cards">
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form class="card" method="POST" action="/workers-store">
                                        @csrf
                                        {{-- <div class="card-header">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($jsa_skills_or_positions as $jsa_skill_or_position)
                                                            <option class="text-sm"
                                                                ...
                                                                {{ in_array($jsa_skill_or_position->uuid, old('jsa_skill_or_position_uuid', [])) ? 'selected' : '' }}>
