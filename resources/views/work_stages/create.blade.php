...
@section('title', 'SASANDO | Tahapan Kerja - create')
@section('content')
                ...
                <div class="row row-cards">
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form class="card" method="POST" action="/work_stages-store">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($potential_hazards as $potential_hazard)
                                                            <option class="text-sm" value="{{ $potential_hazard->uuid }}"
                                                                {{ in_array($potential_hazard->uuid, old('jsa_potential_hazard_uuid', [])) ? 'selected' : '' }}>
                                                    ...
                                                    <select class="form-select @error('jsa_pic_uuid') is-invalid @enderror"
                                                        ...
                                                        @foreach ($pics as $pic)
                                                            <option class="text-sm" value="{{ $pic->uuid }}"
                                                                {{ in_array($pic->uuid, old('jsa_pic_uuid', [])) ? 'selected' : '' }}>
                                                                {{ $pic->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
