...
@section('title', 'SASANDO | Safety Permit - edit')
@section('content')
                ...
                <div class="row row-cards">
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form class="card" method="POST" action="/forms-update/{{ $form->uuid }}">
                                        @csrf
                                        @method('PUT')
                                        {{-- <div class="card-header">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                    ...
                                                    <select class="form-select @error('jsa_uuid') is-invalid @enderror"
                                                        ...
                                                        @foreach ($jsas as $jsa)
                                                            <option value="{{ $jsa->uuid }}"
                                                                {{ (old('jsa_uuid') ?? $form->jsa_uuid) == $jsa->uuid ? 'selected' : '' }}>
                                                                {{ $jsa->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3 col-md-6 col-lg-6">
                                                    <label class="form-label required" for="jsa_safety_permit_uuid">Safety
                                                        Permit</label>
                                                    <select
                                                        class="form-select @error('jsa_safety_permit_uuid') is-invalid @enderror"
                                                        name="jsa_safety_permit_uuid" id="jsa_safety_permit_uuid">
                                                        ...
                                                        @foreach ($safety_permits as $safety_permit)
                                                            <option value="{{ $safety_permit->uuid }}"
                                                                {{ (old('jsa_safety_permit_uuid') ?? $form->jsa_safety_permit_uuid) == $safety_permit->uuid ? 'selected' : '' }}>
                                                                {{ $safety_permit->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @if (!$form->jsa->uuid || !$form->jsa_safety_permit_uuid)
                                            ...
                                            <div class="row">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($person_groups as $person_group)
                                                            <option value="{{ $person_group->uuid }}"
                                                                {{ (old('jsa_person_group_uuid') ?? $form->jsa_person_group_uuid) == $person_group->uuid ? 'selected' : '' }}>
                                                                {{ $person_group->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3 col-md-6 col-lg-6">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('to_carry_out_work') ?? $form->to_carry_out_work }}"
                                                ...
                                                <div class="mb-3 col-md-6 col-lg-6">
                                                    <label class="form-label required" for="unit_territory">Lokasi</label>
                                                    <input autocomplete="off" type="text"
                                                        class="form-control @error('unit_territory') is-invalid @enderror"
                                                        id="unit_territory" name="unit_territory"
                                                        value="{{ old('unit_territory') ?? $form->unit_territory }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            value="{{ old('finish_date') ?? $form->finish_date }}">
                                                        @error('finish_date')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            value="{{ old('start_time') ?? $form->start_time }}">
                                                        @error('start_time')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="mb-3 col-md-6 col-lg-6">
                                                    <label class="form-label" for="job_base_number">Nomer WO</label>
                                                    <input autocomplete="off" type="text"
                                                        class="form-control @error('job_base_number') is-invalid @enderror"
                                                        id="job_base_number" name="job_base_number"
                                                        value="{{ old('job_base_number') ?? $form->job_base_number }}"
                                                        placeholder="Masukkan Bidang Cancellation User">
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            value="{{ old('delay_start_date') ?? $form->delay_start_date }}">
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    <label class="form-label" for="myDatePickerDateFinish">Tanggal mulai
                                                        kerja dari
                                                        penundaan</label>
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            value="{{ old('delay_finish_date') ?? $form->delay_finish_date }}">
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            value="{{ old('delay_start_time') ?? $form->delay_start_time }}">
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    <label class="form-label" for="myDatePickerTimeFinish">Waktu
                                                    ...
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            placeholder="Masukkan Waktu mulai kerja dari penundaan"
                                                            value="{{ old('delay_finish_time') ?? $form->delay_finish_time }}">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($additional_notes as $additional_note)
                                                            <option class="text-sm" value="{{ $additional_note->uuid }}"
                                                                {{ in_array($additional_note->uuid, old('form_additional_note_uuid', $form->form_form_additional_note->pluck('form_additional_note_uuid')->toArray() ?? [])) ? 'selected' : '' }}>
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($descriptions as $description)
                                                            <option class="text-sm" value="{{ $description->uuid }}"
                                                                {{ in_array($description->uuid, old('form_description_uuid', $form->form_form_description->pluck('form_description_uuid')->toArray() ?? [])) ? 'selected' : '' }}>
                                                                {{ $description->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3 col-md-12 col-lg-12">
                                                    <label class="form-label required"
                                                        for="multiple-select-field-protective_equipment">Alat
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($protective_equipments as $protective_equipment)
                                                            <option class="text-sm"
                                                                ...
                                                                {{ in_array($protective_equipment->uuid, old('form_protective_equipment_uuid', $form->form_form_protective_equipment->pluck('form_protective_equipment_uuid')->toArray() ?? [])) ? 'selected' : '' }}>
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($workers as $worker)
                                                            <option class="text-sm" value="{{ $worker->uuid }}"
                                                                {{ in_array($worker->uuid, old('jsa_worker_uuid', $form->form_jsa_worker->pluck('jsa_worker_uuid')->toArray() ?? [])) ? 'selected' : '' }}>
                                                                {{ $worker->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('approve_start_competent_person') ?? $form->approve_start_competent_person }}"
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('approve_start_production_supervisor') ?? $form->approve_start_production_supervisor }}"
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    <label class="form-label required"
                                                        for="approve_start_job_field">Bidang Approve Start User
                                                        Pekerjaan</label>
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('approve_start_job_field') ?? $form->approve_start_job_field }}"
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    <label class="form-label required"
                                                        for="approve_start_job_user">Approve Start User Pekerjaan</label>
                                                    <input autocomplete="off" type="text"
                                                        class="form-control @error('approve_start_job_user') is-invalid @enderror"
                                                        id="approve_start_job_user" name="approve_start_job_user"
                                                        value="{{ old('approve_start_job_user') ?? $form->approve_start_job_user }}"
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    <label class="form-label required"
                                                        for="clearance_competent_person">Clearance Competent Person</label>
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('clearance_competent_person') ?? $form->clearance_competent_person }}"
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('clearance_production_supervisor') ?? $form->clearance_production_supervisor }}"
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('clearance_job_user') ?? $form->clearance_job_user }}"
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('third_party_person') ?? $form->third_party_person }}"
                                                        placeholder="Masukkan Clearance Competent Person">
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            value="{{ old('third_party_date') ?? $form->third_party_date }}">
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            value="{{ old('third_party_time') ?? $form->third_party_time }}">
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('cancellation_competent_person') ?? $form->cancellation_competent_person }}"
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('cancellation_production_supervisor') ?? $form->cancellation_production_supervisor }}"
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('cancellation_job_user') ?? $form->cancellation_job_user }}"
        ...
        <script>
            $(document).ready(function() {
                                    ...
                                    if (jsa.uuid == idJSA) {
                                        ...
                                        if (jsa.form[0]) {
                                            ...
                                            if (jsa.form[0].uuid !==
                                                ...
                                                enableField(jsa.form[0].start_date, jsa
                                                    .form[0].finish_date, jsa.form[0]
                                                    .start_time, jsa.form[0].finish_time
                                                )
                                            }
                                        } else {
                        ...
                        if (data[0].length > 0) {
                            ...
                            data[0].forEach(jsa => {
                                ...
                                if (jsa.uuid == idJSA) {
                                    ...
                                    var temp = `{{ $form->jsa_safety_permit_uuid }}`;
                                    var temp2 = `{{ old('jsa_safety_permit_uuid') }}`;
                                            ...
                                            if (jsa.jsa_jsa_safety_permit) {
                                                ...
                                                jsa.jsa_jsa_safety_permit.forEach(
                                                    jsa_jsa_safety_permit => {
                                                        ...
                                                        if (temp2 == jsa_jsa_safety_permit
                                                            .jsa_safety_permit.uuid) {
                ...
                function disableField(temp) {
                    ...
                    $('#info4').remove();
                    $('[name="finish_time"]').val(temp
                            .finish_time)
                        .addClass("disabledField").after(`<small id="info4" class="form-hint text-danger">
                                                        Waktu Selesai mengikuti Safety Permit yang Pertama!
                                                    </small>`);
                }

                function enableField($temp1 = null, $temp2 = null, $temp3 = null, $temp4 = null) {
                    $('[name="start_date"]').val($temp1).removeClass("disabledField");
                    $('#info1').remove();
                    $('[name="finish_date"]').val($temp2).removeClass("disabledField");
                    $('#info2').remove();
                    $('[name="start_time"]').val($temp3).removeClass("disabledField");
                    $('#info3').remove();
                    $('[name="finish_time"]').val($temp4).removeClass("disabledField");
                    $('#info4').remove();
                }
