...
@section('title', 'SASANDO | JSA - edit')
@section('content')
                ...
                <div class="row row-cards">
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form class="card" method="POST" action="/jsas-update/{{ $jsa->uuid }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6 col-lg-6">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        id="job_base" name="job_base"
                                                        value="{{ old('job_base') ?? $jsa->job_base }}"
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-6 col-lg-6">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('location') ?? $jsa->location }}">
                                                    @error('location')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($person_groups as $person_group)
                                                            <option value="{{ $person_group->uuid }}"
                                                                {{ old('person_group_uuid') ?? $jsa->person_group_uuid == $person_group->uuid ? 'selected' : '' }}>
                                                                {{ $person_group->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            value="{{ old('start_date') ?? $jsa->start_date }}">
                                                        @error('start_date')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            value="{{ old('finish_date') ?? $jsa->finish_date }}">
                                                        @error('finish_date')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <div class="input-icon">
                                                        <input
                                                            ...
                                                            value="{{ old('start_time') ?? $jsa->start_time }}">
                                                        @error('start_time')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($safety_permits as $safety_permit)
                                                            <option class="text-sm" value="{{ $safety_permit->uuid }}"
                                                                {{ in_array($safety_permit->uuid, old('jsa_safety_permit_uuid', $jsa->jsa_jsa_safety_permit->pluck('jsa_safety_permit_uuid')->toArray())) ? 'selected' : '' }}>
                                                                {{ $safety_permit->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($workers as $worker)
                                                            <option class="text-sm" value="{{ $worker->uuid }}"
                                                                {{ in_array($worker->uuid, old('jsa_worker_uuid', $jsa->jsa_jsa_worker->pluck('jsa_worker_uuid')->toArray())) ? 'selected' : '' }}>
                                                                {{ $worker->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($work_tools as $work_tool)
                                                            <option class="text-sm" value="{{ $work_tool->uuid }}"
                                                                {{ in_array($work_tool->uuid, old('jsa_work_tool_uuid', $jsa->jsa_jsa_work_tool->pluck('jsa_work_tool_uuid')->toArray())) ? 'selected' : '' }}>
                                                                {{ $work_tool->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($work_stages as $work_stage)
                                                            <option class="text-sm" value="{{ $work_stage->uuid }}"
                                                                {{ in_array($work_stage->uuid, old('jsa_work_stage_uuid', [])) || ($jsa && in_array($work_stage->uuid, $jsa->jsa_jsa_work_stage->pluck('jsa_work_stage_uuid')->toArray())) ? 'selected' : '' }}>
                                                                {{ $work_stage->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('jsa_creator') ?? $jsa->jsa_creator }}"
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('jsa_creator_position') ?? $jsa->jsa_creator_position }}"
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('jsa_supervisor_k3') ?? $jsa->jsa_supervisor_k3 }}"
                                                ...
                                                <div class="mb-3 col-md-3 col-lg-3">
                                                    ...
                                                    <input autocomplete="off" type="text"
                                                        ...
                                                        value="{{ old('jsa_supervisor_k3_unit') ?? $jsa->jsa_supervisor_k3_unit }}"
                                                ...
                                                <div class="mb-3 col-md-6 col-lg-6">
                                                    ...
                                                    <select class="form-select @error('status') is-invalid @enderror"
                                                        ...
                                                        @foreach ($statusses as $status)
                                                            <option value="{{ $status }}"
                                                                {{ old('status') ?? $jsa->status == $status ? 'selected' : '' }}>
                                                                {{ $status }}
                                                            </option>
                                                        @endforeach
                                                    </select>
