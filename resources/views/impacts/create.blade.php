...
@section('title', 'SASANDO | Dampak - create')
@section('content')
                ...
                <div class="row row-cards">
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form class="card" method="POST" action="/impacts-store">
                                        @csrf
                                        <div class="card-body">
                                            <div class="row">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($danger_controls as $danger_control)
                                                            <option class="text-sm" value="{{ $danger_control->uuid }}"
                                                                {{ in_array($danger_control->uuid, old('jsa_danger_control_uuid', [])) ? 'selected' : '' }}>
                                                                {{ $danger_control->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @error('jsa_danger_control_uuid')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                    @enderror
